<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="thong-tin-thanh-toan.aspx.cs" Inherits="thong_tin_thanh_toan" %>
            ...
            <div id="box-content">
                <div class="section-cart info-buy">
                    <div class="addres-info box-left">
                        <h2 class="tit-tb">Địa chỉ giao hàng</h2>
                        <div class="form-info">
                            <div class="info-input">
                                <label class="info-lb">Họ và tên</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtFullName1" CssClass="info-textbox" runat="server" placeholder="-- Họ và tên --" Text=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb">Điện thoại</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtPhone1" CssClass="info-textbox" runat="server" Text="" placeholder="0909******"></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb">Email</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtEmail1" CssClass="info-textbox" runat="server" Text="" placeholder="-- Email nhận thông tin khuyến mãi --"></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb">Địa chỉ giao hàng</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtAddress1" CssClass="info-textbox" runat="server" Text="" placeholder="-- Địa chỉ --"></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb">Quận/ Huyện</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtDistrict" CssClass="info-textbox" runat="server"
                                        Text="" placeholder="-- Quận/ Huyện --"></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb">Tỉnh/ Thành phố</label>
                                <div class="info-text">
                                    <asp:DropDownList ID="ddlTinh" CssClass="selectb" runat="server" >
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb info-l16">Ghi chú</label>
                                <div class="info-text">
                                    <asp:TextBox ID="txtGhiChu" CssClass="info-area" runat="server" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                            <div class="info-input">
                                <label class="info-lb info-l16">Điều khoàn mua hàng</label>
                                <div class="info-text">
                                        <div class="description">
                                        <p>Cám ơn quý khách đã truy cập vào website MẮT KÍNH.VN được vận hành bởi SUSTAINABILITY CO. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của bạn. Xin vui lòng đọc bản Chính sách bảo mật dưới đây để hiểu hơn những cam kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của người truy cập.</p>
                                        ...
                                        <p>Các khoản thanh toán trực tuyến sẽ được xử lý bởi các đại lý Mạng lưới Quốc tế của chúng tôi. Quý khách chỉ đưa cho chúng tôi hoặc Đại lý hoặc website những thông tin chính xác, không gây nhầm lẫn và phải thông báo cho chúng tôi nếu có thay đổi.</p>
                                        ...
                                        <h3>Điều lệ khác về thông tin cá nhân</h3>
                                        ...
                                        <h3>Đối tác thứ ba và Liên kết</h3>
                                        ...
                                        <p>MẮT KÍNH và các nhà cung cấp bên thứ ba, bao gồm Google, có thể sử dụng cookies của Google Analytics hoặc cookies của bên thứ ba (như DoubleClick) để thu thập thông tin, tối ưu hóa và phục vụ cho mục đích quảng cáo dựa trên lần truy cập website của người dùng trong quá khứ.</p>
                                        <h2>2. Sử dụng Cookie</h2>
                                        <p>Cookie là tập tin văn bản nhỏ có thể nhận dạng tên truy cập duy nhất từ máy tính của bạn đến máy chủ của chúng tôi khi bạn truy cập vào các trang nhất định trên website và sẽ được lưu bởi trình duyệt internet lên ổ cứng máy tính của bạn. Cookie được dùng để nhận dạng địa chỉ IP, lưu lại thời gian. Chúng tôi dùng cookie để tiện cho quý khách vào web (ví dụ: ghi nhớ tên truy cập khi bạn muốn vào thay đổi lại giỏ mua hàng mà không cần phải nhập lại địa chỉ email của mình) và không đòi hỏi bất kỳ thông tin nào về bạn (ví dụ: mục tiêu quảng cáo). Trình duyệt của bạn có thể được thiết lập không sử dụng cookie nhưng điều này sẽ hạn chế quyền sử dụng của bạn trên web. Xin vui lòng chấp nhận cam kết của chúng tôi là cookie không bao gồm bất cứ chi tiết cá nhân riêng tư nào và an toàn với virus. Muốn biết thêm về cookie, vui lòng truy cập <a href="webhttp://www.allaboutcookies.org">webhttp://www.allaboutcookies.org</a> hoặc để tìm hiểu cách loại bỏ cookie khỏi trình duyệt, vui lòng vào <a href="http://www.allaboutcookies.org/manage-cookies/index.html">http://www.allaboutcookies.org/manage-cookies/index.html</a>.</p>
                            ...
                            <div class="info-input">
                                <div class="info-btn">
                                    <asp:CheckBox ID="chkAgee" runat="server" Text="Tôi đã đọc, hiểu và đồng ý với các điều khoản của Vietclio Aloha Fashion" CssClass="check-ok plo" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="addres-info box-right">
                        <h2 class="tit-tb">Hình thức thanh toán</h2>
                        <div class="form-info">
                            <p class="fsi">Aliquam dapibus tincidunt metus praesent justo dolor, lobortis quis, lobortis dignissim ulvinar ac lorem</p>
                            <asp:RadioButtonList ID="RadioButtonList1" CssClass="list-cart" runat="server">
                        ...
                        <h2 class="tit-tb top-line">Thông tin đơn hàng</h2>
                        <div class="form-info">
                            <p class="fsi">Bạn có 3 sản phẩm trong giỏ hàng</p>
                            <div class="table-responsive">
                                <table class="cart-tb table" cellpadding="0" cellspacing="0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3" class="f-line"><span>Thành tiền</span><strong>680.000 </strong></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"><span>Phí ship</span> <strong>680.000 </strong></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"><span>Tổng cộng</span> <strong>680.000 </strong></td>
                                        </tr>
                                    </tfoot>
                                    <tbody>
                                                <tr>
                    ...
                    <div class="box-register text-center">
                        <div class="btn-register">
                            ...
                            <asp:Button ID="Button1" runat="server" 
                                CssClass="btn-a" Text="Hoàn thành đơn đặt hàng" />
                        </div>
                    </div>
                </div>
            </div>
