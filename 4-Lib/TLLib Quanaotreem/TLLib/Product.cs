    ...
    public class Product
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Ri", string.IsNullOrEmpty(Ri) ? dbNULL : (object)Ri);
                cmd.Parameters.AddWithValue("@ThongSoSize", string.IsNullOrEmpty(ThongSoSize) ? dbNULL : (object)ThongSoSize);
                cmd.Parameters.AddWithValue("@ChatLieu", string.IsNullOrEmpty(ChatLieu) ? dbNULL : (object)ChatLieu);
