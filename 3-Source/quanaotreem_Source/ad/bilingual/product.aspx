                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%">
                        <ItemTemplate>
                            <div style="width: 36px">
                                <img alt="Thêm size & color" title="Thêm size & color" src="../assets/images/PhotoAlbum.png"
                                    onclick="openWindow('productsizecolor.aspx?PI=<%# Eval("ProductID") %>','Thêm size & color')"
