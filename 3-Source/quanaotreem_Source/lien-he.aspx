                    ...
                    <div class="cart-form">
                        <div class="send-mail">
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-text">
                                    <asp:TextBox CssClass="input-text corner" ID="txtHoTen" runat="server"></asp:TextBox>
                                    <asp:TextBoxWatermarkExtender ID="txtHoTen_WatermarkExtender" runat="server"
                                            Enabled="True" WatermarkText="Nhập họ tên..." TargetControlID="txtHoTen">
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-text">
                                    ...
                                    <asp:TextBoxWatermarkExtender ID="txtPhone_WatermarkExtender" runat="server"
                                            Enabled="True" WatermarkText="Nhập điện thoại..." TargetControlID="txtPhone">
                                        </asp:TextBoxWatermarkExtender>
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-text">
                                    ...
                                    <asp:TextBoxWatermarkExtender ID="txtEmail_WatermarkExtender" runat="server"
                                            Enabled="True" WatermarkText="Nhập email..." TargetControlID="txtEmail">
                                        </asp:TextBoxWatermarkExtender>
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-text">
                                    <asp:TextBox CssClass="input-area corner" ID="txtNoiDung" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    <asp:TextBoxWatermarkExtender ID="txtNoiDung_WatermarkExtender" runat="server"
                                            Enabled="True" WatermarkText="Nhập nội dung..." TargetControlID="txtNoiDung">
                                        </asp:TextBoxWatermarkExtender>
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-text">
                                    <div class="codes">
                                        ...
                                        <asp:RadCaptcha ID="MyCaptcha1" ValidatedTextBoxID="txtVerifyCode" ValidationGroup="SendEmail"
