...
//function===============================================================================================
    ...
    function colorlink() {
        ...
        mycolor(urlfirt);
        var thisfirst = $("#colorN .link-color:first");
        mynameselect(thisfirst);
    ...
    function mynameselect(namethis) {
        
            //Tien
            var produtcolorid = namethis.attr("productcolorid");
            var productcolorname = namethis.attr("productcolorname");
            var productid = $("[id$='hdnProductID']").attr("value");
            $('#loading').html('<img src="assets/images/loading.gif">');
            $.ajax({
                type: "POST",
                url: "san-pham-chi-tiet.aspx/LoadSize",
                ...
                success: function (msg) {
                    if (msg.d != "") {
                        $("[id$='ddlProductLength'] select").html(msg.d);
                        $.uniform.update("[id$='ddlProductLength']");
                        $('#loading').html(msg);
                    }
                }
            });
    ...
    function mymap() {
        ...
        //Thay dia chi web
        var endAddress = "10.770161, 106.673498";
        //Thay toa do
        var lat = 10.770161, long = 106.673498;
        mufunmap();
