<%@ Page Title="" Language="C#" MasterPageFile="~/site-support.master" AutoEventWireup="true"
    CodeFile="mau-ma-phong-phu.aspx.cs" Inherits="ho_tro_khach_hang" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    <span>Mẫu mã phong phú</span>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h4 class="title-list mobile-992">
        <a class="panel-a" href="#mobileRight" data-position="false" data-type="false">Mẫu mã phong phú<span class="icona glyphicon glyphicon-chevron-down"></span></a></h4>
