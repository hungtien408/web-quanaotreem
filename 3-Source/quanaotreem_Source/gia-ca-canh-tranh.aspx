<%@ Page Title="" Language="C#" MasterPageFile="~/site-support.master" AutoEventWireup="true"
    CodeFile="gia-ca-canh-tranh.aspx.cs" Inherits="ho_tro_khach_hang" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    <span>Giá cả cạnh trạnh</span>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="head desktop-992">
        <h4 class="title-d">
            Giá cả cạnh trạnh</h4>
    </div>
    <h4 class="title-list mobile-992">
        <a class="panel-a" href="#mobileRight" data-position="false" data-type="false">Giá cả cạnh trạnh<span class="icona glyphicon glyphicon-chevron-down"></span></a></h4>
